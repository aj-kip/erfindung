...
inline UInt32 fp_multiply(UInt32 a, UInt32 b) {
...
inline UInt32 fp_inverse(UInt32 a) {
...
inline UInt32 fp_divide(UInt32 a, UInt32 b) {
...
inline double fixed_point_to_double(UInt32 fp) {
